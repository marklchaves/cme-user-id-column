 ...
 * Description: Create a custom column to display a sortable user ID column on the Users page.
...
// Support Sorting
function caughtmyeye_sortable_users_column( $columns ) {
    $columns['user_id'] = 'User ID';
...
add_filter( 'manage_users_sortable_columns', 'caughtmyeye_sortable_users_column' );
